...
HELP_PIC = "https://envs.sh/Ynn.jpg"

DEAD_HELP = "🔥 sɪᴅʜɪ x ᴍᴜsɪᴄ 🔥\n\n"
...
DEAD_HELP += f"© @SIDHI_SUPPORT\n"


@BOT0.on(events.NewMessage(incoming=True, pattern='/help'))
async def help(event):               
    if event.sender_id in SUDOERS:
       blaze = [[Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/TG_BIO_STYLE"), Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/SIDHI_SUPPORT")]]
